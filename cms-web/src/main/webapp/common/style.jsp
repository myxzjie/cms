...
<!--[if lt IE 9]>
<script type="text/javascript" src="${ctx}/resources/assets/lib/html5.js"></script>
<script type="text/javascript" src="${ctx}/resources/assets/lib/respond.min.js"></script>
<script type="text/javascript" src="${ctx}/resources/assets/lib/PIE-2.0beta1/PIE_IE678.js"></script>
<![endif]-->
<link href="${ctx}/resources/assets/css/H-ui.css" rel="stylesheet" type="text/css" />
