...
<div class="pd-20">
	...
	<form action="${ctx}/wxaccount/${model.wxAccId==null?'save':'update'}" method="post" class="form form-horizontal" id="form_add">
		
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>公众帐号名称：</label>
			<div class="formControls col-5">
				<input type="hidden" name="wxAccId" value="${model.wxAccId}">
				<input type="text" class="input-text" placeholder="" name="wxName" datatype="*" nullmsg="公众帐号名称" value="${model.wxName}">
			</div>
			<div class="col-4"> </div>
		</div>
		
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>公众微信号：</label>
			<div class="formControls col-5">
				<input type="text" placeholder="" autocomplete="off" class="input-text " datatype="*" nullmsg="不能为空" name="wxCode" value="${model.wxCode}">
			</div>
			<div class="col-4"> </div>
		</div>
		
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>公众帐号TOKEN：</label>
			<div class="formControls col-5">
				<input type="text" placeholder="" autocomplete="off" class="input-text " datatype="*" nullmsg="不能为空" name="token" value="${model.token}">
			</div>
			<div class="col-4"> </div>
		</div>
		
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>公众号类型：</label>
			<div class="formControls col-5">
		...
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>公众帐号邮箱：</label>
			<div class="formControls col-5">
		...
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>公众帐号APPID：</label>
			<div class="formControls col-5">
				<input type="text" class="input-text" placeholder="" name="appid"  datatype="*" nullmsg="不能为空"  value="${model.appid}">
			</div>
			<div class="col-4"> </div>
		</div>
		
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>公众帐号APPSECRET：</label>
			<div class="formControls col-5">
				<input type="text" placeholder="" autocomplete="off" class="input-text " name="appsecret" datatype="*" nullmsg="不能为空"  value="${model.appsecret}">
			</div>
			<div class="col-4"> </div>
		</div>		
		...
		<div class="row cl">
			<label class="form-label col-3">公众帐号描述：</label>
			<div class="formControls col-5">
...
<script type="text/javascript" src="${ctx}/resources/assets/js/wechat/wxaccount/wechat_edit.js"></script>
