...
<div class="pd-20">
	...
	<a href="javascript:;" onclick="tgridObj.sync();" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe6ab;</i>菜单同步到微信</a>
...
<script type="text/javascript" src="${ctx}/resources/assets/js/wechat/wxbutton/wxbutton_index.js"></script>
