...
<div class="pd-20">
	<div class="text-l"> 
		...
		<input type="text" class="input-text" style="width:150px" placeholder="角色名称" id="" name="roleName">
		角色编码：
		<input type="text" class="input-text" style="width:150px" placeholder="角色编码" id="" name="roleCode">
		组织系统:
		<select class="select" id="orgId" name="orgId" style="width:150px" ></select>
	...
	<a href="javascript:;" onclick="tgridObj.permission();" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe61d;</i> 设置授权</a>
	</span> 
...
<script type="text/javascript" src="${ctx}/resources/assets/js/role/role_index.js"></script>
