...
<div class="pd-20">
	<div class="text-l"> 
		...
		<input type="text" class="input-text" style="width:250px" placeholder="组织名称" id="" name="orgName">
...
<script type="text/javascript" src="${ctx}/resources/assets/js/org/org_index.js"></script>
