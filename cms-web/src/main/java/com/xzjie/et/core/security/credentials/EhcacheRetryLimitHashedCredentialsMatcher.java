package com.xzjie.et.core.security.credentials;
...
public class EhcacheRetryLimitHashedCredentialsMatcher extends HashedCredentialsMatcher {

    private Cache<String,AtomicInteger> passwordRetryCache;

    private String cacheKeyName="passwordRetryCache";
