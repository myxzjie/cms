...
public class RegexUtils {
	...
	public static boolean checkEmail(String email) {
		...
		String regex = "^([a-z0-9A-Z_-]+[-|\\.]?)+[a-z0-9A-Z_-]@([a-z0-9A-Z_-]+(-[a-z0-9A-Z_-]+)?\\.)+[a-zA-Z]{2,}$";
	 ...
	 * @return
	 */
	public static String outMobile(String mobile) {
	...
	/**
	 * 用户名仅可使用数字,字母和下划线,且不能为纯数字
	 * 
	 * @return
	 */
	public static boolean checkUserName(String userName) {
		//String regex = "^(?=.*?[a-zA-Z_])(?=.*?[0-9])[a-zA-Z0-9_]{6,}$";
		String regex="^[a-z-A-Z]{1}([a-z-A-Z0-9_]){1,19}$";
